...
function Learn() {
  return (
    <>
    <div className='max-w-[1240px] mx-auto height-[350px] bg-[#F5F4F6]  grid grid-cols-3 '>
        <div className='h-[250px] col-span-1 mt-3 '>
            <img src={web} className='h-[250px] w-full ' />
        </div>
    ...
    <div className='max-w-[1240px] mx-auto height-[350px] bg-[#F5F4F6] grid grid-cols-3 '>
        <div className='h-[250px]  col-span-1 mt-3 '>
            <img src={ml} className='h-[250px] w-full ' />
        </div>
        <div className='h-[250px]  col-span-2 mt-3 ml-4 '>
    ...
    <div className='max-w-[1240px] mx-auto height-[350px] bg-[#F5F4F6]  grid grid-cols-3 '>
        <div className='h-[250px] col-span-1 mt-3 '>
            <img src={pm} className='h-[250px] w-full ' />
        </div>
        <div className='h-[250px] col-span-2 mt-3 ml-4 '>
